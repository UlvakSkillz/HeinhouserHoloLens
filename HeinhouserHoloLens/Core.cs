...
namespace HeinhouserHoloLens
{
	...
	public class Core : MelonMod
	{
		...
		public override void OnLateInitializeMelon()
		{
			...
			RumbleModUI.UI.instance.UI_Initialized += UIInit;
		}
		...
		private void UIInit()
		{
			...
			settings.Add(HeinhouserHoloLens.AddToList("Show HoloLens in Game", true, 0, "Toggles Camera Visual On/Off", new Tags { }));
